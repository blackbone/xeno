...
public sealed partial class TestSystem
{
    ...
    [SystemMethod(SystemMethodKind.Update)] private static void SystemMethod2(in Entity entity, ref Position position) { }
    [SystemMethod(SystemMethodKind.Update)] private static void SystemMethod3(in float uniform, ref Position position) { }
    [SystemMethod(SystemMethodKind.Update)] private static void SystemMethod4(in Entity entity, in float uniform, ref Position position) { }
}