...
using Register = Func<Func<SyntaxNode, CancellationToken, bool>, Func<GeneratorSyntaxContext, CancellationToken, SystemGroup>, IncrementalValuesProvider<SystemGroup>>;

internal static class SystemRegistrationCollector {
    public static IncrementalValuesProvider<SystemGroup> Register(Register register) => register(Check, Transform);
